...
INSERT INTO member (first_name, last_name, email, password, address, birthday, national_registry, id_role, email_checked, id_checked)
VALUES ('Test', 'User2', 'test@root.com', '$argon2id$v=19$m=19456,t=2,p=1$hTNOkj8jWws8MWdHFj6GoA$s41XpdWq1QVPPKOu9jomE52qexww7mcCjjgKwIKfnAE', 'Test Address', '2000-01-01', '000000-000-03', 2, true, true);

...
VALUES ('root', 'root', 'root@root.com', '$argon2id$v=19$m=65536,t=3,p=4$GWApmfpjEMd9wlCVh5+qMw$Ijmzcn32ghNg2Ntmu0Ev/Qk3qs+UI0ENdQFgJBXj59w', 'root', '2000-01-01', '000000-000-00', 1, true, true); --test
